...
卡路里 TS 迁移重构为全 TS 并纯 SKILL 可用：唯一出口 cmd_read，envelope 全字段，HELP 现找可执行。体量：py 214 个约 52.3k 行，SKILL.md 2195 行，13 表，10 场景，联动 router+作息/备忘/训记。唤醒词单文件 4467 行与 schema 先行，真实 DB 禁迁。
