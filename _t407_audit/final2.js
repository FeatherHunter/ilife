...
const RE = /^t407-(浠ｈ〃-璁版敮鍑簗椤?.+)-(閲囬泦椤祙鍥炴墽椤?\.html$/;
...
for (const h of tn.filter(x=>x.zone==='VISIBLE')) console.log(h.file+'  L'+h.line+'  銆?+h.tok+'銆? anc='+h.anc+'  text='+JSON.stringify(h.text.slice(0,60)));
