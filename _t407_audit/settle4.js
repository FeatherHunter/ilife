...
for(const nd of nodes){
  ...
  if(t==='amount'||t==='category'||t==='time'){
    console.log('L'+lineOfAt(nd.s)+' text='+JSON.stringify(t)+' anc='+stack.join('>'));
    console.log('   includes pre? '+stack.includes('pre')+'   includes script? '+stack.includes('script')+'   includes style? '+stack.includes('style'));
  }
}
