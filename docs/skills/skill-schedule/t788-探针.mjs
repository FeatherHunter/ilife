...
const CONTRACT = {
  ...
  [P_PROBE_FULL]: [
    { block: '三档探测·全通', needs: ['三道门逐道看', '全通', '拉得动', '这一步只读'] },
    { block: '探测不写', needs: ['这一趟写了几笔', '只读探测，远端一行没动'] },
    { block: '档位互斥', absent: ['这一趟的账', '远端新建'] },
  ],
  [P_PROBE_PARTIAL]: [
    { block: '三档探测·不完全', needs: ['不完全', '把 lark-cli 的授权补上', '没过'] },
    { block: '档位互斥', absent: ['这一趟的账'] },
  ],
  [P_PROBE_MISSING]: [
    { block: '三档探测·没装', needs: ['没装', '本技能不代装也不代登', '没找到'] },
    { block: '档位互斥', absent: ['这一趟的账'] },
  ],
  [P_SYNC]: [
...
const FROZEN_FINGERPRINT = { src: 'ed2b6298cafa93b0', dist: '0cae6af3933f11b9' };
