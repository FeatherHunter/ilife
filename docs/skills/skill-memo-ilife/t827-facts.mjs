/** #827 · facts.json 生成件（只读产物；口径逐字复用 `separator-probe.mjs` 的可见文本剥壳）。
 *
 ...
 *
 *  跑法（仓根）：node docs/skills/skill-memo-ilife/t827-facts.mjs   # 入仓件＝本件；.scratch/t827/t827-facts.mjs 是同内容的会话内副本
 */
...
const DIR = join(ROOT, '.scratch', 't827');
...
const facts = {
  ...
  dir: DIR,
  ticket: '#827 · skill-memo-ilife 过渡期五维尺判分（判分件见 docs/skills/skill-memo-ilife/t827-判分.mjs）',
  method: {
