...
const SEED = [
  ...
  ['calorie.diet.add', { foodName: '燕麦片', grams: 60, calories: 228, protein: 8, carbohydrates: 40, fat: 4, date: TODAY, time: '07:20' }],
  ['calorie.diet.add', { foodName: '鸡胸肉', grams: 150, calories: 248, protein: 46, carbohydrates: 0, fat: 5, date: TODAY, time: '12:10', note: '煎的，少油' }],
  ['calorie.diet.add', { foodName: '米饭', grams: 200, calories: 232, protein: 5, carbohydrates: 52, fat: 1, date: TODAY, time: '19:05' }],
  ['calorie.diet.add', { foodName: '全麦面包', grams: 80, calories: 212, protein: 7, carbohydrates: 39, fat: 2, date: D1, time: '07:30' }],
  ['calorie.diet.add', { foodName: '牛肉面', grams: 400, calories: 520, protein: 24, carbohydrates: 72, fat: 14, date: D1, time: '12:40' }],
  ['calorie.diet.add', { foodName: '鸡胸肉', grams: 150, calories: 248, protein: 46, carbohydrates: 0, fat: 5, date: D2, time: '12:10' }],
  ['calorie.diet.add', { foodName: '燕麦片', grams: 60, calories: 228, protein: 8, carbohydrates: 40, fat: 4, date: D2, time: '07:20' }],
