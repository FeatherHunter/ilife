...
本票只写自己那几族：`packages/skill-home/templates/stats/<族>.html` 与 `packages/skill-home/src/stats/pages/<族>.ts`（族 = `overview`、`idle`、`expiring`、`inventory_stat`），外加 `packages/skill-home/test/stats.test.mjs`、`docs/skills/skill-home/scene-stats.md`、`.scratch/811/`。
