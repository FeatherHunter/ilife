/** dsh-ilife-home 槽位描述（P10 脚手架，P3 #4 定案）。
 *
 * 写死槽位原生组件：id 命名空间 ilife:home，order 85。
 * 注册与打开只走 registerTab/openTab 的路径导航；子页后缀（如 ilife:home:*）
...
export const PLUGIN = 'dsh-ilife-home' as const;
...
export const TAB_COMPONENT = { kind: 'native', name: 'HomePanel' } as const;
