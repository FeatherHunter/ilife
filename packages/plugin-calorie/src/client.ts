...
function CalorieConfig(props: { getCall: GetCall; pickerSource: () => DirectoryPickerFace | null }): React.ReactElement {
...
export function apply(ctx: ClientCtx): void {
  ...
  ctx.slots.inject('ilife.config-tab', () =>
    ctx.slots.register(
      ...
      () => React.createElement(CalorieConfig, { getCall, pickerSource: getPicker }),
    ),
  );
