...
#   dsh-memo-ilife 0.2.1（槽位 ilife:memo／order 70、打包技能提供方、
#     CLI 单轨桥；精确 pin skill-memo-ilife@0.3.0）
#
# 前提（硬门，第 1 stage 会自动查，不满足即停）：
# skill-memo-ilife@0.3.0 必须已在 registry 上 —— 插件对它是精确 pin，
...
say "备忘录插件 0.2.1：槽位 ilife:memo／order 70、打包技能提供方、CLI 单轨桥。"
