...
test('#136 ① 模板值 verbatim：前后缀哈希与搬家基线一致', () => {
  ...
  assert.equal(sha(HELP_SHELL_SUFFIX), '46d8ce4ec191f2904faaccf0e4736ec0dca008250022845e33a9ef5ee60aa121');
...
test('#136 ② 固定夹具渲染逐字节一致＋空分组抛 missing-data', () => {
  assert.equal(sha(renderHelpShellHtml(FIXTURE)), '9180a3de80a620215884a90e1023057ec1d1b2896e3d19aefc426f74f870f039');
