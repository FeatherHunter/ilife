...
export const SPEC_FROZEN_SURFACE: readonly FrozenSurfaceEntry[] = Object.freeze([
  ...
  { name: 'STRICT_ENVELOPE_SHAPES', kind: 'runtime', ticket: '#74', status: 'implemented', section: '3.1', signature: "readonly ['list', 'detail', 'stat', 'receipt', 'analysis', 'fallback', 'resultset']" },
