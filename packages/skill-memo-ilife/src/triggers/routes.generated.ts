 ...
 *
 * 唤醒词记录面：29 条（各域 `routes.ts` 的声明按 `order` 升序拼出）。
...
export const WAKE_ROUTES: readonly WakeRoute[] = [
  ...
  { wakeWord: '查已提醒备忘', scene: 'memo_completed_reminders', key: 'memo.remind', cli: 'memo-cmd-read memo.remind --params \'{"mode":"done"}\'' },
  ...
  { wakeWord: '完成心愿', scene: 'memo_complete_wish', key: 'memo.update', cli: 'memo-cmd-read memo.update --params \'{"id":1,"done":true}\'', needs: ['id'], preset: { done: '[object Object]' } },
