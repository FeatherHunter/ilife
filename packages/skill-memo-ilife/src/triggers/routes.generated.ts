...
export const WAKE_ROUTES: readonly WakeRoute[] = [
  ...
  { wakeWord: '记打卡', scene: 'memo_add_checkin', key: 'memo.create', cli: 'memo-cmd-read memo.create --params \'{"content":"跑步5公里","category":"打卡","sub_category":"跑步"}\'', preset: { category: '打卡' } },
  ...
  { wakeWord: '改打卡', scene: 'memo_update_checkin', key: 'memo.update', cli: 'memo-cmd-read memo.update --params \'{"id":1,"content":"跑步6公里"}\'', needs: ['id'], preset: { category: '打卡' } },
