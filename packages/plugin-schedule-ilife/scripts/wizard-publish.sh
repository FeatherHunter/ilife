...
#   dsh-schedule-ilife 0.2.0（槽位 ilife:schedule／order 80、打包技能提供方、
#     CLI 单轨桥；精确 pin skill-schedule@0.2.0）
#
# 前提（硬门，第 1 stage 会自动查，不满足即停）：
# skill-schedule@0.2.0 必须已在 registry 上 —— 插件对它是精确 pin，
...
say "作息管家插件 0.2.0：槽位 ilife:schedule／order 80、打包技能提供方、CLI 单轨桥。"
