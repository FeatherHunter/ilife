/**
 * #863 · 脏标记与跟随态（作息）——改动行有标记、派生行进跟随态、保存栏吸底常显。
 * 运行：`node --test packages/plugin-schedule-ilife/test/t863-脏态.test.mjs`。
 */
...
/** 整面那一张卡的输入（就绪态 ＋ 一张脏行表）。 */
const SURFACE = {
  path: 'C:\\Users\\x\\.ilife\\schedule.yaml',
