/** dsh-ilife-bill 槽位描述（P10 脚手架，P3 #4 定案）。
 *
 * 写死槽位原生组件：id 命名空间 ilife:cookie，order 95。
 * 注册与打开只走 registerTab/openTab 的路径导航；子页后缀（如 ilife:cookie:*）
...
export const SLOT_TITLE = '记账' as const;
export const PLUGIN = 'dsh-ilife-bill' as const;
...
export const TAB_COMPONENT = { kind: 'native', name: 'BillPanel' } as const;
