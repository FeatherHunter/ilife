/** dsh-ilife-bill 取数桥（P10 脚手架：纯 CLI 单轨）。
 *
...
export const SKILL_PACKAGE = '@feather_wch/skill-bill' as const;
...
export const MANAGER_MISSING_HINT =
  '总管缺席，请补装：dsh plugin add dsh-life-pack dsh-ilife-bill（不许单卸总管）';
