 ...
 *     对账折叠区 ● → 退出口 ○ → 复制区 ●
 *
 * 谁在用（六个调用点，指名）：`src/record/scene-{refund,reimburse-done,lend,borrow,collect,repay}.ts`——
...
import { candidatePick, candidateRows } from '../shared/candidatePick.js';
...
import type { FlowField, FlowStepInput } from '../shared/flowSteps.js';
