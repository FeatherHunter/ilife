...
export const PAGE_META = {
  ...
  shape: 'list',
  preset: {"kind":"missing"} as Record<string, unknown>,
  rows: [{"key":"home.shopping.query","preset":{"kind":"missing"}}] as readonly { readonly key: string; readonly preset: Record<string, unknown> }[],
} as const;
