...
// #43 H2：analysis/fallback/resultset 经 HOME_KEY_SHAPES 不可达本函数（视图键仅 list/detail/receipt/stat；
// 数据族 resultset 走出口层短路直回 envelope，不进 HTML 交付链），保留作显式降级与未来扩展直调分支，单测直构 envelope 覆盖。
