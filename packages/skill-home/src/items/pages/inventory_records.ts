...
+ '.chip{border:1.5px solid #d2d2d7;background:#fff;border-radius:999px;padding:6px 14px;font-size:13px;min-height:44px}'
...
export function renderFamilyPage(env: Envelope): string {
  ...
  const content = '<div class="hero"><p class="eyebrow">查看</p>'
    ...
    + body
    + '<h2>差异计数</h2><p class="lead">计数随各记录的展开详情逐条展开</p></section>'
    + '<section class="sec" data-block="status" data-need="' + NEED.status + '"><h2>记录状态</h2>'
    + '<div class="chips"><span class="chip">进行中</span><span class="chip">已完成</span><span class="chip">已处理</span><span class="chip">已复查</span></div></section>'
