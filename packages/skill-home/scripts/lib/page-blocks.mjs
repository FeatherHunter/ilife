...
export const PAGE_BLOCKS = {
  ...
  'photo_wall': { domain: 'items', scenarios: ["5-3"], requiredBlocks: {"empty":["空态：没有带照片的物品","补充态：还有N件无照片→去补拍","异常：数据解析失败"],"fields":["分组（分类/位置）","照片网格","无照片件数"],"operations":["全部","类型筛选","去补拍","按位置浏览","点图复制详情prompt","复制数据","复制日志"],"status":["照片类型四值"]} },
