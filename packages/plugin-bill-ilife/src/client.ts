 ...
 * 本家**不再有**自己的样式表与行渲染函数：改一次共用面板，六家一起变；跨包那两道锁改指向
 * 共用件之后仍然守住「六家同形」这条性质（见 #910）。
...
const DB_FOLLOWERS: readonly string[] = ['db.name', 'db.goals', 'html.dir', 'backup.dir', 'backup.stem'];
