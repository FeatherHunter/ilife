...
export const WORKOUT_ROUTES: readonly RouteDecl[] = [
  ...
  { list: 'new', order: 58, wakeWord: '确认定训练计划', scene: '05', kind: 'exec', key: 'calorie.workout.plan-set', cli: 'calorie-cmd-read calorie.workout.plan-set --params \'{"plan":{"config":{"title":"示例计划","start_date":"2026-09-07","user_level":"中手","available_equipment":["瑜伽垫"]},"weeks":[{"week_number":1,"days":[{"day_of_week":1,"sessions":[{"session_label":"上肢","movements":[{"name":"俯卧撑"}]}]}]}]}}\'' },
  { list: 'new', order: 59, wakeWord: '确认复制训练计划', scene: '05', kind: 'exec', key: 'calorie.workout.plan-copy', cli: 'calorie-cmd-read calorie.workout.plan-copy --params \'{"newTitle":"示例副本"}\'' },
  { list: 'new', order: 60, wakeWord: '确认定一周计划', scene: '05', kind: 'exec', key: 'calorie.workout.plan-set-week', cli: 'calorie-cmd-read calorie.workout.plan-set-week --params \'{"week":1,"days":[{"dayOfWeek":1,"sessionLabel":"上肢","movements":[{"name":"俯卧撑"}]}]}\'' },
  { list: 'new', order: 61, wakeWord: '确认加训练动作', scene: '05', kind: 'exec', key: 'calorie.workout.plan-add-movement', cli: 'calorie-cmd-read calorie.workout.plan-add-movement --params \'{"week":1,"dayOfWeek":1,"movement":{"name":"深蹲"}}\'' },
  { list: 'new', order: 62, wakeWord: '确认定休息日', scene: '05', kind: 'exec', key: 'calorie.workout.plan-set-rest', cli: 'calorie-cmd-read calorie.workout.plan-set-rest --params \'{"week":1,"dayOfWeek":3}\'' },
  { list: 'new', order: 63, wakeWord: '确认改训练计划', scene: '05', kind: 'exec', key: 'calorie.workout.plan-update', cli: 'calorie-cmd-read calorie.workout.plan-update --params \'{"title":"示例改名"}\'' },
  { list: 'new', order: 64, wakeWord: '确认改某天训练', scene: '05', kind: 'exec', key: 'calorie.workout.plan-update-day', cli: 'calorie-cmd-read calorie.workout.plan-update-day --params \'{"week":1,"dayOfWeek":3,"newLabel":"下肢＋核心"}\'' },
  { list: 'new', order: 65, wakeWord: '确认删某天训练', scene: '05', kind: 'exec', key: 'calorie.workout.plan-delete-day', cli: 'calorie-cmd-read calorie.workout.plan-delete-day --params \'{"week":1,"dayOfWeek":3}\'' },
  { list: 'new', order: 66, wakeWord: '确认改动作', scene: '05', kind: 'exec', key: 'calorie.workout.plan-update-movement', cli: 'calorie-cmd-read calorie.workout.plan-update-movement --params \'{"oldMovement":"硬拉","newMovement":{"name":"杠铃划船"}}\'' },
  { list: 'new', order: 67, wakeWord: '确认撤销训练计划', scene: '05', kind: 'exec', key: 'calorie.workout.plan-delete', cli: 'calorie-cmd-read calorie.workout.plan-delete --params \'{"confirm":true}\'' },
];
