...
export const PHOTO_COMMANDS = [
  ...
  { kind: 'write', key: 'calorie.photo.remove', title: '删身材照', wakeWord: '删身材照', run: writePhotoRemove, example: 'calorie-cmd-read calorie.photo.remove --params \'{"id":1}\'' },
  { kind: 'write', key: 'calorie.photo.tag', title: '改照片标签', wakeWord: '改照片标签', run: writePhotoTag, example: 'calorie-cmd-read calorie.photo.tag --params \'{"id":1,"op":"add","tag":"晨起"}\'' },
