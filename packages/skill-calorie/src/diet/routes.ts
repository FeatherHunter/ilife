/** 饮食能力**已搬迁键**的路由声明（键属 `src/diet/commands.ts` 的 `DIET_COMMANDS` 声明键集）。
 *
 * #315：由未搬迁分片机械搬出——**记录归属＝它 `key` 的所有者**，一个键的记录可能散在多片
 * （本票 77 条来自 `routes/scene-02.ts` 61 条 ＋ `routes/scene-10.ts` 16 条）；语义不动、只换住处，
 * 那两片里对应的行由落点脚本读**当前**文件定点删除（一个键恰住一处）。
 * `order` 仍是该记录在**原列表内**的 0 基位次（顺序权威，**原值照抄、不重排**）。
 * 生成器（`scripts/gen-routes.mjs`）把各件按 `(list, order)` 复原成三个列表，故换文件搬记录不打乱顺序。
 * 本件**恰好导出一个**声明数组（生成器要求）；键集与 `./commands.ts` 的声明键集一一对应。
 */
import type { RouteDecl } from '../triggers/routeSpec.js';

export const DIET_ROUTES: readonly RouteDecl[] = [
  ...
  { list: 'wake', order: 78, wakeWord: '看「有备注」的饮食记录', scene: '02', kind: 'exec', key: 'calorie.today', cli: 'calorie-cmd-read calorie.today --params \'{"date":"今日","hasNote":true}\'' },
  { list: 'wake', order: 390, wakeWord: '看三大营养交叉(最近 30 天)', scene: '10', kind: 'exec', key: 'calorie.view.diet-review', cli: 'calorie-cmd-read calorie.view.diet-review --params \'{"window":"30d"}\'' },
  { list: 'wake', order: 391, wakeWord: '看三大营养交叉(最近 90 天)', scene: '10', kind: 'exec', key: 'calorie.view.diet-review', cli: 'calorie-cmd-read calorie.view.diet-review --params \'{"window":"90d"}\'' },
  { list: 'wake', order: 392, wakeWord: '看三大营养交叉(自定义)', scene: '10', kind: 'exec', key: 'calorie.view.diet-review', cli: 'calorie-cmd-read calorie.view.diet-review --params \'{"window":"custom","start":"<开始日期>","end":"<结束日期>"}\'' },
  { list: 'wake', order: 414, wakeWord: '今日复盘', scene: '10', kind: 'exec', key: 'calorie.view.diet-review', cli: 'calorie-cmd-read calorie.view.diet-review --params \'{"window":"今日"}\'' },
  { list: 'wake', order: 416, wakeWord: '复盘', scene: '10', kind: 'exec', key: 'calorie.view.diet-review', cli: 'calorie-cmd-read calorie.view.diet-review --params \'{"window":"今日"}\'' },
  { list: 'wake', order: 417, wakeWord: '复盘日期范围', scene: '10', kind: 'exec', key: 'calorie.view.diet-review', cli: 'calorie-cmd-read calorie.view.diet-review --params \'{"window":"7d"}\'' },
  { list: 'wake', order: 419, wakeWord: '本周复盘', scene: '10', kind: 'exec', key: 'calorie.view.diet-review', cli: 'calorie-cmd-read calorie.view.diet-review --params \'{"window":"本周"}\'' },
  { list: 'wake', order: 420, wakeWord: '本年复盘', scene: '10', kind: 'exec', key: 'calorie.view.diet-review', cli: 'calorie-cmd-read calorie.view.diet-review --params \'{"window":"今年"}\'' },
  { list: 'wake', order: 421, wakeWord: '本月复盘', scene: '10', kind: 'exec', key: 'calorie.view.diet-review', cli: 'calorie-cmd-read calorie.view.diet-review --params \'{"window":"本月"}\'' },
  { list: 'wake', order: 422, wakeWord: '查低热量榜', scene: '10', kind: 'exec', key: 'calorie.view.ranking', cli: 'calorie-cmd-read calorie.view.ranking --params \'{"category":"low_calorie","topN":10,"window":"7d"}\'' },
  { list: 'wake', order: 428, wakeWord: '查营养结构', scene: '10', kind: 'exec', key: 'calorie.view.diet-review', cli: 'calorie-cmd-read calorie.view.diet-review --params \'{"window":"7d"}\'' },
  { list: 'wake', order: 431, wakeWord: '查频繁吃榜', scene: '10', kind: 'exec', key: 'calorie.view.ranking', cli: 'calorie-cmd-read calorie.view.ranking --params \'{"category":"frequent","topN":10,"window":"7d"}\'' },
  { list: 'wake', order: 432, wakeWord: '查食物排行', scene: '10', kind: 'exec', key: 'calorie.view.ranking', cli: 'calorie-cmd-read calorie.view.ranking --params \'{"topN":10,"window":"7d"}\'' },
  { list: 'wake', order: 433, wakeWord: '查高热量榜', scene: '10', kind: 'exec', key: 'calorie.view.ranking', cli: 'calorie-cmd-read calorie.view.ranking --params \'{"window":"7d"}\'' },
  { list: 'wake', order: 434, wakeWord: '查高碳水榜', scene: '10', kind: 'exec', key: 'calorie.view.ranking', cli: 'calorie-cmd-read calorie.view.ranking --params \'{"category":"high_carb","topN":10,"window":"7d"}\'' },
  ...
  { list: 'new', order: 31, wakeWord: '看去重报告', scene: '02', kind: 'exec', key: 'calorie.view.dedupe', cli: 'calorie-cmd-read calorie.view.dedupe' },
  { list: 'new', order: 39, wakeWord: '查营养配比', scene: '02', kind: 'exec', key: 'calorie.view.nutrition-ratio', cli: 'calorie-cmd-read calorie.view.nutrition-ratio --params \'{"window":"7d"}\'' },
  { list: 'new', order: 40, wakeWord: '看营养素明细', scene: '02', kind: 'exec', key: 'calorie.view.nutrition-detail', cli: 'calorie-cmd-read calorie.view.nutrition-detail --params \'{"window":"7d","entry":"detail"}\'' },
  { list: 'new', order: 41, wakeWord: '看食品来源分布', scene: '02', kind: 'exec', key: 'calorie.view.source-stats', cli: 'calorie-cmd-read calorie.view.source-stats' },
  { list: 'new', order: 42, wakeWord: '看今日饮水', scene: '02', kind: 'exec', key: 'calorie.view.today-water', cli: 'calorie-cmd-read calorie.view.today-water --params \'{"date":"今日"}\'' },
  { list: 'new', order: 43, wakeWord: '看批量导入预览', scene: '02', kind: 'exec', key: 'calorie.view.batch-import-preview', cli: 'calorie-cmd-read calorie.view.batch-import-preview --params \'{"items":[{"foodName":"粥","calories":150,"protein":3,"date":"<日期>"}]}\'' },
];
