...
export const HOME_ROUTES: readonly RouteDecl[] = [
  ...
  { list: 'wake', order: 76, wakeWord: '看加餐（最近 7 天）', scene: '02', kind: 'exec', key: 'calorie.view.diet', cli: 'calorie-cmd-read calorie.view.diet --params \'{"window":"7d","meal":"加餐"}\'' },
  { list: 'wake', order: 77, wakeWord: '看全部餐别分布（最近 7 天）', scene: '02', kind: 'exec', key: 'calorie.view.diet', cli: 'calorie-cmd-read calorie.view.diet --params \'{"window":"7d","meal":"all"}\'' },
