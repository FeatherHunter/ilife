...
import { dietCalorieTrend, dietDeficitAnalysis, dietMacroRatio } from '../diet/dietEngine.js';
import type { CalorieTrend, DeficitAnalysis, MacroRatio } from '../diet/dietEngine.js';
