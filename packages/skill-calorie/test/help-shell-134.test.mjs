...
test('#134 ③ 手机端≤500px 沉浸：stage 归零＋screen 滚动容器＋sheet iOS 抽屉', () => {
  ...
  assert.ok(
    html.includes('.sheet{left:0;right:0;transform:translateY(105%);bottom:0;width:auto;max-height:94%;border-radius:22px 22px 0 0}'),
    'sheet 须变 iOS 抽屉（C 案定案＋未展开藏屏外，否则常驻空弹窗）',
  );
});
