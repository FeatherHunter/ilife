...
export function renderInitReceiptPage(input: InitReceiptInput): string {
  ...
  const content = [
    ...
    renderCaliberLine('库文件落在这里 ｜ ' + input.paths.dbFile),
...
export function renderFirstUsePage(input: FirstUseInput): string {
  ...
  const content = [
    ...
    renderCaliberLine('库目录 ｜ ' + input.paths.dbDir),
    renderCaliberLine('库文件 ｜ ' + input.paths.dbFile),
    renderCaliberLine('页面落在这里 ｜ ' + input.paths.pagesRoot),
    renderCaliberLine('帮助页落在这里 ｜ ' + input.paths.helpDir),
