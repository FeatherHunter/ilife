...
| 初始化数据库 | schedule.help.lookup | list | `schedule-cmd-read schedule.help.lookup --params '{"view":"init"}'` |
...
| 首次使用 | schedule.help.lookup | list | `schedule-cmd-read schedule.help.lookup --params '{"view":"firstUse"}'` |
