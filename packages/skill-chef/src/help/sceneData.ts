 ...
 *           映射后 48 条 sha256＝ea4d05fb2e3cfe63823de89d46b482d8f513f2478f42c6e2db703cf02abc225d
 *
...
export const CHEF_SCENES: readonly SceneGroup[] = [
  ...
  { id: 'search', icon: '🔍', label: '搜索筛选', subgroups: [
    ...
    { id: '筛选难度', label: '筛选难度', scenes: [
      { id: 'filter_difficulty_easy', title: '按难度筛选', wake_word: '筛选难度', types: ['查看'], status: '', prompt_template: '来个简单的。', editable_fields: [{ name: 'difficulty', label: 'difficulty', value: '简单/快手菜' }] },
    ] },
    { id: '筛选时间', label: '筛选时间', scenes: [
      { id: 'filter_time_quick', title: '按时间筛选(30 分钟内)', wake_word: '筛选时间', types: ['查看'], status: '', prompt_template: '30 分钟内的菜。', editable_fields: [{ name: 'time_max', label: 'time_max', value: '30 分钟' }] },
    ] },
    { id: '筛选炊具', label: '筛选炊具', scenes: [
      { id: 'filter_by_cookware', title: '按炊具筛选', wake_word: '筛选炊具', types: ['查看'], status: '', prompt_template: '用砂锅做的菜。', editable_fields: [{ name: 'cookware', label: 'cookware', value: '砂锅/高压锅等' }] },
    ] },
    ...
    { id: '筛选状态', label: '筛选状态', scenes: [
      { id: 'filter_by_status', title: '按状态筛选', wake_word: '筛选状态', types: ['查看'], status: '', prompt_template: '已做的菜。', editable_fields: [{ name: 'status', label: 'status', value: '未做/已做/熟练/已废弃' }] },
    ] },
  ...
  { id: 'add', icon: '📝', label: '录入', subgroups: [
    ...
    { id: '导入食谱', label: '导入食谱', scenes: [
      { id: 'import_from_json', title: 'JSON 文件导入', wake_word: '导入食谱', types: ['采集', '回执'], status: '', prompt_template: '导入食谱 [JSON 文件]。', editable_fields: [{ name: 'input', label: 'input', value: 'JSON 文件' }] },
      { id: 'import_validation_failed', title: '导入校验失败(补齐后重试)', wake_word: '导入食谱', types: ['采集', '回执'], status: '', prompt_template: '导入这个 JSON。', editable_fields: [{ name: 'input', label: 'input', value: 'JSON 有缺字段' }] },
    ] },
  ] },
  { id: 'relation', icon: '🌿', label: '派生', subgroups: [
    ...
    { id: '查看派生关系', label: '查看派生关系', scenes: [
      { id: 'view_relation_tree', title: '查看派生关系(家族树)', wake_word: '查看派生关系', types: ['查看'], status: '', prompt_template: '看看{{菜名}}的家族关系。', editable_fields: [{ name: 'recipe', label: 'recipe', value: '指定菜名' }] },
    ] },
