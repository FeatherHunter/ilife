...
// HELP 速查唯一上游；改这里，HELP 构建期跟进。35 条 = help4 + view6 + search7 + write4 + cooking4 + shopping4 + record3 + query3。
...
export const WAKE_TABLE: WakeEntry[] = [
  ...
  { phrase: '查看全部', key: 'chef.recipe.view' },
  ...
  { phrase: '查清单', key: 'chef.shopping.query' },
  { phrase: '清空清单', key: 'chef.shopping.query' },
  ...
  { phrase: '查看统计', key: 'chef.history.query' },
  { phrase: '体检', key: 'chef.history.query' },
];
