...
describe('P10 安装验收', () => {
  ...
  it('单品 dependencies 硬依赖总管（开发兜底声明仍在）', () => {
    // #48 样板线：plugin-calorie 已转正式版号 ^0.1.0＋skill 同版本 ^ 声明；#50 首对复制 plugin-chef、home 对 plugin-home-ilife、bill 对 plugin-bill-ilife、schedule 对 plugin-schedule-ilife 同改。
